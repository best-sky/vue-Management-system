<template>
  <div class="EquipmentManagement">
    <div class="addManagement">
      ...
      <el-button type="primary" @click="addManagement()">增加设备</el-button>
    </div>
        ...
        <el-table-column label="操作" align="center">
          <template slot-scope="scope">
            ...
            <el-button
              ...
              size="small"
            >回收设备</el-button>
            <el-button disabled v-else type="primary" size="small">回收设备</el-button>
            <el-button
              @click.stop="distribution(scope.$index, tableData)"
              v-if="tableData[scope.$index].equiprole =='22'"
              type="primary"
              size="small"
            >分配设备</el-button>
            <el-button disabled v-else type="primary" size="small">分配设备</el-button>
          </template>
        </el-table-column>
      </el-table>
    </div>
    ...
    <div class="dialog-distribution">
      <el-dialog title="分配设备" :visible.sync="dialogDistribution">
...
export default {
  ...
  methods: {
    ...
    recovery(index, rows){
      this.$axios
        .get("/equip/rebackEquip", {
          params: {
            equipId: rows[index].equipid,
            id:this.userName
          }
        })
        .then(res => {
    ...
    getList() {
      this.$axios.get("/equip/equiplist").then(res => {
